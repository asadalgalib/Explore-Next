    ...
    <div className="bg-base-200 min-h-screen">
      <div className="max-w-screen-2xl mx-auto py-10 px-4 md:px-8">
        <div className="md:py-10 py-5 bg-white rounded-md">
          <h1 className="md:text-3xl text-2xl text-black font-semibold text-center">Read Blogs</h1>
        </div>
        ...
        <div className="flex justify-center items-center pt-10">
          <Link href='/blog'><button className="px-4 py-2 bg-indigo-500 text-white font-semibold rounded-md">View All</button></Link>
        </div>
      </div>
    </div>
  );
